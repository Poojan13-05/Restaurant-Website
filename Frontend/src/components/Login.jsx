...
const Login = () => {
    ...
    const handleLogin = async(e)=>{
        e.preventDefault()
        try {const response=await axios.post('https://restaurant-website-g29s.vercel.app/api/auth/login',{
            email,
            password
        });
    ...
    const handleRegister=async(e)=>{
        ...
        e.preventDefault()
        try {const response=await axios.post('https://restaurant-website-g29s.vercel.app/api/auth/register',{
            username,
            email,
            password
        });
